...
Write a CPython function that takes a list of integers as input and calculates their average.

Name the package `CPythonLearn7` and the function `average_calculation`.
